...
class ImageMetadata(BaseModel):
    ...
    original_dimensions: tuple[int, int] = Field(..., description="원본 이미지 크기 (width, height)")
    converted_dimensions: tuple[int, int] = Field(..., description="변환된 이미지 크기 (width, height)")
